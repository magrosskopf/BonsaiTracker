...
export type UserEntitlementRow = Row<"user_entitlements">;
export type StripeCustomerRow = Row<"stripe_customers">;
export type StripeWebhookEventRow = Row<"stripe_webhook_events">;
